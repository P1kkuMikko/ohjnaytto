...
export class DigiClock {
  constructor(el) {
    this.el = el;
    this.timezoneSelector = this.el.querySelector(".timezone-selector");
    this.localTimezone = Intl.DateTimeFormat().resolvedOptions().timeZone;
    this.localTime = new Date().toLocaleString("en-US", { timeZone: this.localTimezone });
  ...
  updateClock() {
    const clockElement = this.el.querySelector(".clock");
    const timezoneSelector = this.el.querySelector(".timezone-selector");
